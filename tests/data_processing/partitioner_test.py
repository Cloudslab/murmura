...
def validate_partitions(partitions: Dict[int, List[int]], dataset_size: int, num_partitions: int):
...
class TestDirichletPartitioner:
    ...
    def test_init_with_invalid_alpha_length(self):
        ...
        with pytest.raises(ValueError, match="Alpha length must match number of partitions"):
