...
def test_model_dump():
    ...
    config = DPConfig(target_epsilon=5.0, mechanism=DPMechanism.LAPLACE)
...
def test_preset_configurations():
    ...
    mnist_config = DPConfig(target_epsilon=8.0, target_delta=1e-5, max_grad_norm=1.0)
    ...
    medical_config = DPConfig(target_epsilon=3.0, target_delta=1e-6, max_grad_norm=0.5)
