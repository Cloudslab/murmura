...
class DPFedAvg(AggregationStrategy):
    ...
    def aggregate(
        ...
        for param_name in param_names:
            ...
            param_arrays = [client_params[param_name] for client_params in parameters_list]
...
class DPSecureAggregation(AggregationStrategy):
    ...
    def aggregate(
        ...
        for param_name in param_names:
            ...
            if self.dp_config.enable_central_dp:  # Using central_dp flag for aggregation DP
...
class DPTrimmedMean(AggregationStrategy):
    ...
    def _simple_average_with_dp(self, parameters_list: List[Dict[str, Any]]) -> Dict[str, Any]:
