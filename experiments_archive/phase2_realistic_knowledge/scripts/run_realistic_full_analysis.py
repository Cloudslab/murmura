...
from rerun_attacks_realistic_partial_knowledge import (
...
def main():
    ...
    viz_base = Path(
        "experiments_archive/results/training_visualizations/visualizations_phase1"
    )
    ...
    print(
        f"This will generate approximately {len(all_experiments)} × 6 scenarios = {len(all_experiments) * 6} attack evaluations"
    )
    ...
    print(
        "Results saved to: experiments_archive/results/attack_results/realistic_knowledge_full_analysis/"
    )
