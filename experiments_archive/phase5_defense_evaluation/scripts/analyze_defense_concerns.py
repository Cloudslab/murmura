...
def analyze_dp_baseline_effectiveness():
    ...
    for experiment in baseline_data:
        ...
        if dp_setting in dp_analysis:
            ...
            success_metrics = [
                attack["attack_success_metric"] for attack in attack_results
            ]
...
def analyze_defense_vs_dp_comparison():
    ...
    for dp_level, stats in dp_stats.items():
        ...
        if dp_level == "no_dp":
            ...
            print(
                f"   {dp_level:15}: {success_rate:5.1f}% attack success -> {reduction:5.1f}% reduction (n={count})"
            )
    ...
    defense_ranking = [
        (
            ...
            defense_effectiveness["structural_noise_strong"]["mean"],
        ),
        (
            "structural_noise_medium",
            defense_effectiveness["structural_noise_medium"]["mean"],
        ),
        (
            "structural_noise_weak",
            defense_effectiveness["structural_noise_weak"]["mean"],
        ),
        ...
        (
            ...
            defense_effectiveness["topology_aware_dp_weak"]["mean"],
        ),
        (
            "topology_aware_dp_strong",
            defense_effectiveness["topology_aware_dp_strong"]["mean"],
        ),
        (
            "topology_aware_dp_medium",
            defense_effectiveness["topology_aware_dp_medium"]["mean"],
        ),
    ]
    ...
    print(
        f"   Best Defense Mechanism:    {best_defense_reduction:5.1f}% attack reduction"
    )
    print(
        f"   Difference:                {best_defense_reduction - strong_dp_reduction:+5.1f}% points"
    )
...
def analyze_combined_vs_structural_concern():
    ...
    for attack in attacks:
        ...
        print(
            f"     Loss vs Structural:        {struct_perf - comb_med_perf:+5.1f}% (medium), {struct_perf - comb_str_perf:+5.1f}% (strong)"
        )
...
def main():
    ...
    print(
        "1. Strong DP alone reduced attack success by 18.8% - are our defenses better?"
    )
